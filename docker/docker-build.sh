...
rsync -a --exclude node_modules --exclude .git /home/example-user/pi-mono/packages/agent/ pi-deps/agent/
rsync -a --exclude node_modules --exclude .git /home/example-user/pi-mono/packages/ai/ pi-deps/ai/
