...
export type ProjectAppExecutionPaths = {
  appDir: string;
  projectDir: string;
  workspaceDir: string;
};
...
export function projectAppExecutionPaths(appDir: string, projectDir: string): ProjectAppExecutionPaths {
  return {
...
export function resolveProjectAppOutputPaths(
  outputs: string[],
  paths: Pick<ProjectAppExecutionPaths, "appDir" | "projectDir">,
): string[] {
