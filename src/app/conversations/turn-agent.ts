...
function conversationInputPrompt(
  ...
  return [
    ...
    "Review ordinary worker feedback. To revise an assignment you created, use tasks get then tasks update with its observed generation and complete revised App input before further work. This is the same operation for every App and caller; code records creator identity and delivers the change. taskControls cancel ends exact contextual work within your authority; clear human cancellation remains supported. Send proposed changes to the creator when you do not control the assignment.",
