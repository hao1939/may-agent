...
export function appTaskAgentProtocol(appId: string): string {
  return [
    ...
    "Actions update or unblock existing Tasks using their exact IDs and generations. Never rewrite your own assignment; return its result. Accepted outcomes are evidence; closure belongs to its assigning owner.",
